...
const Hero = ({ color }) => {
  ...
  return (
    <section
      className={`w-full cursor-default bg-${color} xl:px-44 lg:px-40 sm:pt-48 sm:pb-0 pt-28 md:px-32 sm:px-28 vvs:px-12 px-101`}
    >
            ...
            <div className="w-full flex md:flex-row flex-col justify-between items-center ">
              <div>
                <p className=" text-white/60 font-Glimer-Light xl:text-[1.3rem] 2xl:text-[1.5rem] lg:text-base md:text-sm text-xs xl:leading-8 2xl:leading-9 lg:leading-6 leading-5 mb-6 md:mb-0">
                  ...
                  applications. With extensive knowledge of ReactJS and NodeJS,
                  I can effortlessly create complex and dynamic applications.
                </p>
              </div>
